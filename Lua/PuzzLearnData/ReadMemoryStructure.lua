...
function PuzzLearn.MemoryStructure.ProcessAddressPlane(addressPlane)
	...
	if #addressPlane.XCenter == 0 then
	    xMin = addressPlane.XMin
		xMax = addressPlane.XMax
	else
		local xCenterValue = PuzzLearn.MemoryStructure.ProcessIntegerAddressArray(addressPlane.XCenter)
		xMin = xCenterValue + addressPlane.XMin
		xMax = xCenterValue + addressPlane.XMax
	end
	
	if #addressPlane.YCenter == 0 then
	    yMin = addressPlane.YMin
		yMax = addressPlane.YMax
	else
		local yCenterValue = PuzzLearn.MemoryStructure.ProcessIntegerAddressArray(addressPlane.YCenter)
